...
for result_1 in results_1:
    if result_1[0] == '747':
        ...
        # Saving the stopID coordinates lineID wise in separate csv files
        path_for_this_line = '/Users/aausuman/Documents/Thesis/' + str(result_1[0]) + "_files"
        all_coordinates_df.coalesce(1).write.csv(path_for_this_line)
